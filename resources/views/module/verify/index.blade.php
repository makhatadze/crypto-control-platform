                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form>
                                ...
                                <div id="container-driving" style="display: none">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-6">
                                ...
                                <div id="container-national" style="display: none">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group @error('file-passport') has-error @enderror">
                                        <label for="email"></label>
                                            <select class="form-control" name="address">
                                                ...
                                                <option value="4">Original electronic bank or credit card statement in PDF</option>
                                            </select>
                                        @error('file-passport')
                                        <div id="file-passport-error"
                                             class="help-block animated fadeInDown">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group @error('file-passport') has-error @enderror">
                                        <label for="email">
                                            ...
                                            - The document needs to have an issue date within last 1 month, except address in ID or drivers license
                                        </label>
                                        <input class="form-control" name="file-passport" type="file">
                                        @error('file-passport')
                                        <div id="file-passport-error"
